...
Once the image has finished building, the command *s2i usage rimolive/r-343-centos7* will print out the help info that was defined in the *usage* script.

#### Testing the builder image
The builder image can be tested using the following commands:
```
docker build -t rimolive/r-343-centos7-candidate .
IMAGE_NAME=rimolive/r-343-centos7-candidate test/run
```
